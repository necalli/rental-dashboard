...
@app.get("/api/v1/search/listings")
...
@app.get("/api/v1/search/runs/<run_id>/summary")
...
@app.delete("/api/v1/memory/files/<memory_id>")
...
@app.get("/api/v1/enrich/listings/<listing_id>/summary")
...
@app.post("/api/v1/enrich/listings/<listing_id>/summary")
...
@app.post("/api/v1/enrich/compare")
